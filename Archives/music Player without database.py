...
music_view = image_rezizer(r"../photos/play-rounded-button.png", 25, 25)
list_view = image_rezizer(r"../photos/play-rounded-button.png", 25, 25)
...
vol_slider.configure(showvalue=False)
